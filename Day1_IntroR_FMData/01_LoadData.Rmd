...
tmp <- tmp[c(1,7:9,17:19),]          # tmp was created for demonstration purposes only
...
library(FSA)
swvCode(fn,moreItems=c("FSA","knitr","row.names","tmp","1:","fn"),topnotes=c(fn,"Some of the output was suppressed when making the final document.","Thus, running this script will give somewhat different results."))
```
